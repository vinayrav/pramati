...
public class DigitalSign extends CreateSignatureBase
{
...
*/
public DigitalSign(KeyStore keystore, char[] pin)
...
/**
* Sign pdf file and create new file that ends with "signed.pdf".
*
...
DigitalSign signing = new DigitalSign(keystore, pin.clone());
...
signing.signPDF(documentFile, signedDocumentFile, humanRect, tsaUrl, "Signature");
}
